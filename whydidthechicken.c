...
// final.c is the game "why did the chicken...?"
...
int main()
{
	...
	// Open Window
	gfx_open(XSIZE, YSIZE, "why did the chicken...?");
	gfx_clear();
	gfx_color(255,255,255);
	gfx_changefont("12x24");
	gfx_text(XSIZE/2-125,YSIZE/2-15,"Why Did the Chicken...?");
	gfx_changefont("8x13");	gfx_text(XSIZE/2-55,YSIZE/2,"click to start");
	gfx_changefont("9x15");	gfx_text(XSIZE/2-62,YSIZE/2+50,"INSTRUCTIONS:");
	gfx_changefont("8x13");	gfx_text(XSIZE/2-55,YSIZE/2+65,"don't get hit");
	gfx_text(XSIZE/2-80,YSIZE/2+80,"you have nine lives");
	gfx_text(XSIZE/2-95,YSIZE/2+95,"each level gets faster");
	gfx_text(XSIZE/2-63,YSIZE/2+110,"press q to quit");
...
*/
	...
	// black eye
	gfx_color(0,0,0);
	gfx_fill_arc((7.35*XSCALE + *dxplayer*XSCALE+3), (YSIZE-(.75*YSCALE) + *dyplayer*YSCALE+2), 6, 6, 0, 360);
	// orange beak
	gfx_color(255,150,0);
	gfx_line(7.35*XSCALE + *dxplayer*XSCALE, YSIZE-(.6*YSCALE) + *dyplayer*YSCALE, 7.35*XSCALE + *dxplayer*XSCALE-10, YSIZE-(.7*YSCALE) + *dyplayer*YSCALE+10);
	gfx_line(7.35*XSCALE + *dxplayer*XSCALE, YSIZE-(.6*YSCALE) + *dyplayer*YSCALE+10, 7.35*XSCALE + *dxplayer*XSCALE-10, YSIZE-(.7*YSCALE) + *dyplayer*YSCALE+10);
